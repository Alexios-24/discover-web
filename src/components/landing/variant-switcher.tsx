...
export function VariantSwitcher() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[100] hidden lg:flex items-center bg-white/[0.08] backdrop-blur-xl border border-white/[0.1] rounded-full p-1 gap-0.5 shadow-lg">
      <button
