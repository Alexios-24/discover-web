...
export function DiscoverContent() {
  ...
  return (
    <div className="flex gap-[54px] items-start pt-6 px-[54px] pb-9">
      <FiltersPanel filters={filters} onFiltersChange={setFilters} />
      <div className="flex-1 min-w-0 flex flex-col gap-6 items-start">
        {/* Product type switcher + Sort */}
        <div className="flex items-center justify-between w-full sticky top-[60px] z-40 bg-white py-3 relative">
          <div className="absolute inset-y-0 -right-[54px] w-[54px] bg-white" />
          <div className="bg-gray-100 flex items-center justify-center overflow-hidden p-1 rounded-xl w-[406px]">
            {PRODUCT_TABS.map((tab) => (
              <button
                ...
                className={cn(
                  ...
                  tab === "All" ? "px-6" : "flex-1 min-w-0 px-3",
          ...
          <button className="flex flex-col items-start w-[165px] shrink-0 cursor-pointer">
